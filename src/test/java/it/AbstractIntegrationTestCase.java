...
public class AbstractIntegrationTestCase extends AbstractConfluencePluginWebTestCase
{
    ...
    protected JWebUnitConfluenceWebTester createConfluenceWebTester()
    {
        ...
        props.put("confluence.webapp.port", Integer.parseInt(System.getProperty("http.port", "1990")));
        props.put("confluence.webapp.context.path", System.getProperty("context.path", "confluence"));
